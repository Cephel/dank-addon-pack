...
LVBM.AddOns.TwinEmps = {
	...
	["DropdownMenu"] = {
		[1] = {
			["variable"] = "LVBM.AddOns.TwinEmps.Options.BugExplode",
			["text"] = LVBM_TWINEMPS_BUG_EXPLOE,
			["func"] = function() LVBM.AddOns.TwinEmps.Options.BugExplode = not LVBM.AddOns.TwinEmps.Options.BugExplode; end,
		},
	},
	["Events"] = {
