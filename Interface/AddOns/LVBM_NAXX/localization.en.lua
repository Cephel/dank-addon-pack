...
LVBM_FOURHORSEMEN_INFO				= "Provides timers for the Four Horsemen fight";
...
LVBM_FOURHORSEMEN_WHISPER_INFO			= "Whisper players in Void Zones";
LVBM_FOURHORSEMEN_SYNC_INFO			= "Sync mark with other clients";
LVBM_FOURHORSEMEN_INFOFRAME_INFO		= "Show InfoFrame for boss HP during combat";
...
LVBM_SAPPHIRON_PING_INFO		= "Show minimap pings";
