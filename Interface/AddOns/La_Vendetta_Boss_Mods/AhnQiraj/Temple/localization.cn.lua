...
LVBM_THREEBUGS_FEAR_ANNOUNCE		= "*** 亚尔基公主%d秒后施放恐惧 ***";
...
LVBM_SARTURA_DESCRIPTION		= "警报旋风旋风斩"
...
LVBM_DEFENDER_GAIN_EXPLODE		= "阿努比萨斯守卫者获得了爆炸的效果。";
...
LVBM_TWINEMPS_TELEPORT_WARNING		= "*** %s秒后传送 ***";
LVBM_TWINEMPS_ENRAGE_WARNING		= "*** %s%s后狂暴 ***";

LVBM_TWINEMPS_TELEPORT_ANNOUNCE		= "*** 传送 ***";
...
LVBM_OURO_EMERGED_WARNING		= "*** 奥罗钻出地面 - 3分钟后再次潜入 ***";
