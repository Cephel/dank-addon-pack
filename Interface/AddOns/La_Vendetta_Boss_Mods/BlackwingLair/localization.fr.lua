...
--    By Destiny|Tandanu   / By Proreborn            --
-- -------------------------------------------- --
...
LVBM_FIREMAW_WING_BUFFET		= "Gueule de Feu commence \195\160 caster <Frappe d'aile>.";
LVBM_EBONROC_WING_BUFFET		= "Roch\195\169b\195\168ne commence \195\160 caster <Frappe d'aile>.";
LVBM_FLAMEGOR_WING_BUFFET		= "Flamegor commence \195\160 caster <Frappe d'aile>.";

LVBM_FIREMAW_SHADOW_FLAME		= "Gueule de Feu commence \195\160 caster <Flamme d'Ombre>.";
LVBM_EBONROC_SHADOW_FLAME		= "Roch\195\169b\195\168ne commence \195\160 caster <Flamme d'Ombre>.";
LVBM_FLAMEGOR_SHADOW_FLAME		= "Flamegor commence \195\160 caster <Flamme d'Ombre>.";
...
LVBM_SBT["Wing Buffet"]			= "<Frappe d'aile>";
LVBM_SBT["Wing Buffet Cast"]	= "Cast de <Frappe d'Aile>";
LVBM_SBT["Shadow Flame Cast"]	= "Cast de <Flamme d'ombre>";
...
LVBM_CHROMAGGUS_BREATH_CAST_WARNING		= "*** Chromaggus commence \195\160 caster %s ***"
LVBM_CHROMAGGUS_BREATH_WARNING			= "*** %s dans 10 sec ***"

LVBM_CHROMAGGUS_BREATH_REGEXP			= "Chromaggus commence \195\160 caster ([%w%s]+)";
...
LVBM_NEFARIAN_CAST_SHADOW_FLAME	= "Nefarian commence \195\160 cast <Flamme d'Ombre>.";
LVBM_NEFARIAN_CAST_FEAR			= "Nefarian commence \195\160 cast <Rugissement Puissant>.";
...
LVBM_NEFARIAN_YELL_PHASE3		= "Impossible! Rise my minions!  Servez votre Maître une fois encore!";
...
LVBM_NEFARIAN_YELL_DEAD			= "Cela ne peut pas \195\170tre! Je suis le Maître ici! You mortals are nothing to my kind! Do you hear me? Nothing!";
