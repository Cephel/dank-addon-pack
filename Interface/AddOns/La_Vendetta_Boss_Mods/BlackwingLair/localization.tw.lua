...
LVBM_VAEL_BA_WHISPER			= "正在燃燒！";
LVBM_VAEL_BA				= "燃燒刺激";

LVBM_VAEL_BA_REGEXP			= "^(.+)受到(.*)燃燒刺激";
LVBM_VAEL_BA_FADES_REGEXP		= "燃燒刺激效果從(.+)%";


--Firemaw/Ebonroc/Flamegor 費爾默/埃博諾克/弗萊格爾
LVBM_FIREMAW_NAME			= "費爾默";
LVBM_FIREMAW_DESCRIPTION		= "龍翼打擊/暗影烈焰 警報";
LVBM_EBONROC_NAME			= "埃博諾克";
LVBM_EBONROC_DESCRIPTION		= "龍翼打擊/暗影烈焰 警報";
...
LVBM_CHROMAGGUS_BREATH_1		= "第一種吐息 1";
LVBM_CHROMAGGUS_BREATH_2		= "第二種吐息 2";

LVBM_CHROMAGGUS_BREATH_CAST_WARNING	= "*** 克洛瑪古斯施放：%s ***"
LVBM_CHROMAGGUS_BREATH_WARNING		= "*** %s - 10 秒後施放！***"
...
LVBM_SBT["Breath 1"]			= "第一種吐息 1";
LVBM_SBT["Breath 2"]			= "第二種吐息 2";
...
LVBM_NEFARIAN_YELL_PHASE2		= "幹得好，我的手下。";
LVBM_NEFARIAN_YELL_PHASE3		= "^不可能";
...
LVBM_SBT["Class call CD"] 		= "職業點名時間";
LVBM_SBT["Druid call"] 			= "德魯伊";
LVBM_SBT["Priest call"] 		= "牧師";
LVBM_SBT["Warrior call"] 		= "戰士";
LVBM_SBT["Rogue call"] 			= "盜賊";
LVBM_SBT["Mage call"] 			= "法師";
end