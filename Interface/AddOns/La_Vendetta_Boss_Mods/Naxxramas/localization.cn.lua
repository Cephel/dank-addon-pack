...
LVBM_PW_OPTION3						= "显示信息框";

LVBM_PW_ENRAGE_WARNING		= "*** %s%s后狂暴 ***";
...
--Gluth
LVBM_GLUTH_NAME				= "格拉斯";
LVBM_GLUTH_DESCRIPTION		= "通告格拉斯恐惧,狂暴和吞噬.";
LVBM_GLUTH_ANNOUNCE_FRENZY	= "通告狂暴";
...
LVBM_SBT["Disruption Shout"]	= "瓦解怒吼";


--Noth the Plaguebringer
LVBM_NTP_NAME			= "瘟疫使者诺斯";
LVBM_NTP_DESCRIPTION	= "提供诺斯传送和闪现计时.";
...
LVBM_MAEXXNA_DESCRIPTION	= "蛛网喷射和蜘蛛刷新计时器";
...
LVBM_GOTH_PHASE2_WARNING		= "*** 戈提克即将出场 ***";
...
LVBM_THADDIUS_DESCRIPTION	= "提供激怒和极性转换计时.";
...
LVBM_LOATHEB_ANNOUNCE_SPORES		= "警报孢子"
--LVBM_LOATHEB_ANNOUNCE_SPORES_BACKWARDS		= "Announce spores to Groups Backwards";
LVBM_LOATHEB_HEAL_RAID				= "在团队频道中警报医疗";
LVBM_LOATHEB_HEAL_RAID_WARN			= "在团队警报中警报医疗";
LVBM_LOATHEB_HEAL_WHISPER			= "密语下一位医疗";
LVBM_LOATHEB_ANNOUNCE_POT_OPTION	= "警报消耗品(可能和贵会的策略不同)";
LVBM_LOATHEB_SPECIALWARN_POT_OPTION	= "当你需要使用药品的时候显示特殊警报(可能和贵会的策略不同)";
LVBM_LOATHEB_HEAL_SHOW_AUTO			= "当洛欧塞布触发时显示医疗框体"
LVBM_LOATHEB_HEAL_SHOW_NOW			= "显示医疗框体"
...
LVBM_LOATHEB_SPORE_SPAWNED		= "*** 孢子刷新 ***";
...
LVBM_LOATHEB_REMOVE_CURSE		= "洛欧塞布对洛欧塞布施放了驱散诅咒。";
