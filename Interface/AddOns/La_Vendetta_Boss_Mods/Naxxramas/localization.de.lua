if GetLocale() == "deDE" then
	...
	LVBM_PWSTATS_STRIKES		= "Hasserf�llte St��e: %s (%.0f%%)";
	...
	LVBM_PWSTATS_MAX_HIT		= "H�chster Treffer: %s auf %s";
	LVBM_PWSTATS_PER_PLAYER		= "%s Hasserf�llte St��e auf %s (%s Treffer)";
	LVBM_PWSTATS_NOT_AVAILABLE	= "Stats nicht verf�gbar";
	...
	LVBM_FOURHORSEMEN_MARK_EXPR			= "ist von Mal von (.+) betroffen";
