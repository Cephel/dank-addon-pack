...
LVBM_MOD_ENABLED		= "首领模块打开.";
LVBM_MOD_DISABLED		= "首领模块关闭.";
LVBM_ANNOUNCE_ENABLED	= "通告打开.";
...
LVBM_FOUND_CLIENTS		= "找到%s名玩家正在使用 Vendetta Boss Mods";

--Sync options
LVBM_SOMEONE_SET_SYNC_CHANNEL	= "%s 设置同步频道为: %s";
...
LVBM_REC_STOP_ALL				= "停止接收来自 %s 的所有命令.";
...
LVBM_REQ_PATCHNOTES		= "向 %s 请求更新记录...请等待.";
