...
LVBMGUI_ABOUTTEXT_1	= "LV Bossmods API (c)：Destiny Tandanu";
LVBMGUI_ABOUTTEXT_2	= "LV Bossmods GUI (c)：La Vendetta Nitram";
LVBMGUI_ABOUTTEXT_3	= "汉化：Diablohu";
LVBMGUI_ABOUTTEXT_4	= " ";
LVBMGUI_ABOUTTEXT_5	= "感谢您使用我们的插件";
LVBMGUI_ABOUTTEXT_6	= " ";
LVBMGUI_ABOUTTEXT_7	= "                              访问";
LVBMGUI_ABOUTTEXT_8	= " ";
LVBMGUI_ABOUTTEXT_9	= "                www.deadlyminds.net";
LVBMGUI_ABOUTTEXT_10	= " ";
LVBMGUI_ABOUTTEXT_11	= "                               或";
LVBMGUI_ABOUTTEXT_12	= " ";
LVBMGUI_ABOUTTEXT_13	= "                www.destiny-guild.de";
LVBMGUI_ABOUTTEXT_14	= " ";
LVBMGUI_ABOUTTEXT_15	= "              www.curse-gaming.com";
LVBMGUI_ABOUTTEXT_16	= " ";
LVBMGUI_ABOUTTEXT_17	= " ";
LVBMGUI_ABOUTTEXT_18	= "如果您有什么建议或错误报告，请在 www.curse-gaming.com 留言或在 www.deadlyminds.net 的论坛发表。";
...
LVBMGUI_INFOFRAME_TOOLTIP_TEXT		= "右键点击以移动、nShift+右键单击以隐藏";
