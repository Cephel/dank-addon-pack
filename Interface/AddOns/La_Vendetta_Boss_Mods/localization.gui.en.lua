...
LVBMGUI_CHECKBOX_ALLOW_STATUS_COMMAND		= "Allow users to get the Fight status (whisper \"status\")";
LVBMGUI_CHECKBOX_SHOWCOMBATINFO			= "Shows combat information like fight length";
...
LVBMGUI_TITLE_RAIDOPTIONS			= "Raid Optionen";
LVBMGUI_CHECKBOX_HIDEPLAYERNAMESINRAIDS		= "Hide Playernames when joining a Raidgroup";
