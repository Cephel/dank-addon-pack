...
function OneCore:OnInitialize()
    ...
    self.modulePrototype.bottomBorder 	= 5
...
function module:SetBorderColor(slot)
    ...
    if special then
        slot:SetNormalTexture("Interface\\AddOns\\ShaguUI\\libs\\OneBag\\BagSlot3")
        slot:GetNormalTexture():SetPoint("TOPLEFT", slot:GetName(), "TOPLEFT", 0, 0)
    else
        slot:SetNormalTexture("Interface\\AddOns\\ShaguUI\\libs\\OneBag\\BagSlot2")
        slot:GetNormalTexture():SetPoint("TOPLEFT", slot:GetName(), "TOPLEFT", 0, 0)
    end
...
function module:HighlightBagSlots(bag)
    ...
    v:SetNormalTexture("Interface\\AddOns\\ShaguUI\\libs\\OneBag\\BagSlot3")
