...
-- frFR localization by Tazmanyak

local AL = AceLibrary("AceLocale-2.1")

AL:RegisterTranslation("OneBank", "enUS", function()
    return {
		["First Bag"]	= true,
...
AL:RegisterTranslation("OneBank", "frFR", function()
    return {
		["First Bag"]	= "Sac 1",
--		["Turns display of your first bag on and off."]	= true,
		["Second Bag"]	= "Sac 2",
...
AL:RegisterTranslation("OneBank", "zhCN", function()
    return {
		["First Bag"]	= "第一个包",
...
AL:RegisterTranslation("OneBank", "deDE", function()
    return {
