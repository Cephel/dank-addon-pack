...
function ShaguPlatesCastBar_Hide(mob, spell)
	if ShaguPlates.CasterDB[mob] and ShaguPlatesCastBar_Spells[spell] and ShaguPlatesCastBar_Spells[ShaguPlates.CasterDB[mob].sp] and
    not (ShaguPlatesCastBar_Spells[spell].ni and ShaguPlatesCastBar_Spells[ShaguPlates.CasterDB[mob].sp].ni) then
