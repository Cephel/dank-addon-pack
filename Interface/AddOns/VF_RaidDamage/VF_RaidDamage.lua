...
VF_RD_YellEventsFR = {
	--MC
	["Majordomo Executus"] = {
		["Imprudents mortels, nul ne d�fie les fils de la Flamme Vivante !"] = VF_RD_YellEvents_Start, --TODO fix utf8
		["Impossible ! Retenez vos coups, mortels ! Je me rends !"] = VF_RD_YellEvents_End,
	},
	["Ragnaros"] = {
		["� VOTRE TOUR INSECTES ! VOUS VOULIEZ CONNA�TRE LE POUVOIR DE RAGNAROS. VOUS ALLEZ LE D�COUVRIR !"] = VF_RD_YellEvents_Start, --TODO fix utf8
		["VENEZ ! � MES SERVITEURS ! VENEZ D�FENDRE VOTRE MA�TRE !"] = VF_RD_YellEvents_Phase2, --TODO fix utf8
	},
	
	--Onyxia
	["Onyxia"] = {
		["Quelle chance. D'habitude je dois quitter mon antre pour me nourrir."] = VF_RD_YellEvents_Start,
		["Ces efforts inutiles m'ennuient. Je vais vous incin�rer depuis les airs."] = VF_RD_YellEvents_Phase2, --TODO fix utf8
		["On dirait que vous avez besoin d'une nouvelle le�on, mortels !"] = VF_RD_YellEvents_Phase3, --TODO fix utf8
	},
	...
	["High Priest Venoxis"] = {
		...
		["La s�r�nit�... enfin !"] = VF_RD_YellEvents_End, --TODO fix utf8
	},
	["High Priestess Mar'li"] = {
		["Entraine moi dans ta toile dame Shadra ! D�chaine ton venin !"] = VF_RD_YellEvents_Start, --TODO fix utf8
		["Soyez b�ni mortel pour m'avoir lib�r�e. Hakkar ne me contr�le plus."] = VF_RD_YellEvents_End, --TODO fix utf8
	},
	["Bloodlord Mandokir"] = {
		["Je jetterai vos �mes en pat�re � Hakkar lui-m�me !"] = VF_RD_YellEvents_Start, --TODO fix utf8
	},
	["High Priest Thekal"] = {
	...
	["High Priestess Arlokk"] = {
		["Bethekk, ta pr�tresse en appelle � ta puissance !"] = VF_RD_YellEvents_Start, --TODO fix utf8
		["Enfin ! Je suis enfin lib�r�e de l'Ecorcheur d'�me !"] = VF_RD_YellEvents_End, --TODO fix utf8
	},
	["Jin'do the Hexxer"] = {
	},
	["Hakkar"] = {
		["L'ORGUEIL ANNONCE LA FIN DE VOTRE MONDE. AVANCEZ MORTELS ! AFFRONTEZ LA COL�RE DE L'ECORCHEUR D'�ME !"] = VF_RD_YellEvents_Start, --TODO fix utf8
	},
	...
	["Vaelastrasz the Corrupt"] = {
		["DESTRUCTION ! Tremblez mortels, devant la col�re du seigneur... Non ! Je dois lutter !"] = VF_RD_YellEvents_Start,--TODO fix utf8
	},
	["Broodlord Lashlayer"] = {
		["Aucun membre de votre esp�ce ne devrait �tre ici. Vous vous �tes condamn�s vous m�mes !"] = VF_RD_YellEvents_Start,--TODO fix utf8
	},
	["Lord Victor Nefarius"] = {--Nefarian
	},
	["Nefarian"] = {
	...
	["Thane Korth'azz"] = {
		...
		["Quel g�chis de sang !"] = VF_RD_YellEvents_End, --TODO fix utf8
	},
	["Lady Blaumeux"] = {
	},
	["Sir Zeliek"] = {
...
VF_RD_LastUploadedData = "2015-09-10 19:50:09";